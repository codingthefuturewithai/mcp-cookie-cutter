...
class ServerConfig:
    ...
    description: str = "MCP server with decorators"
    ...
    def __post_init__(self):
        ...
        self.database_path = self.data_dir / "my_mcp_server.db"
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ServerConfig":
        ...
        return cls(
            ...
            description=data.get("description", "MCP server with decorators"),
