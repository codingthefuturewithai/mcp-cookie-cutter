...
def generate_tool_tests(tool_name: Optional[str] = None) -> int:
    ...
    {% raw %}test_template = '''async def test_{}_execution(self, mcp_session: ClientSession):
...
'''.format(tool_name, tool_name, tool_name, tool_name, tool_name, tool_name, tool_name){% endraw %}
