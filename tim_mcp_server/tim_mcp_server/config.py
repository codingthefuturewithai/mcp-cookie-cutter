...
class ServerConfig:
    ...
    def __post_init__(self):
        ...
        if self.config_dir is None:
            self.config_dir = Path(platformdirs.user_config_dir("tim_mcp_server"))
        if self.data_dir is None:
            self.data_dir = Path(platformdirs.user_data_dir("tim_mcp_server"))
        if self.log_dir is None:
            self.log_dir = Path(platformdirs.user_log_dir("tim_mcp_server"))
...
def get_platform_info() -> Dict[str, str]:
    ...
    return {
        "config_dir": str(platformdirs.user_config_dir("tim_mcp_server")),
        "data_dir": str(platformdirs.user_data_dir("tim_mcp_server")),
        "log_dir": str(platformdirs.user_log_dir("tim_mcp_server")),
        "cache_dir": str(platformdirs.user_cache_dir("tim_mcp_server")),
    }
