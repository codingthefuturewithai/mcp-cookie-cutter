...
def handle_export_config(config):
    ...
    st.download_button(
        ...
        data=config_json,
        file_name="tim_mcp_server_config.json",
...
def render_environment_variables():
    ...
    env_vars = {
        "TIM_MCP_SERVER_LOG_LEVEL": "INFO",
        "TIM_MCP_SERVER_PORT": "3001",
        "TIM_MCP_SERVER_CONFIG_PATH": system_info.get("config_path", "~/.config/tim_mcp_server"),
        "TIM_MCP_SERVER_LOG_PATH": system_info.get("log_path", "~/.local/share/tim_mcp_server"),
...
def main():
    ...
    with col2:
        ...
        st.download_button(
            ...
            data=config_yaml,
            file_name="tim_mcp_server_config.yaml",
