...
from tim_mcp_server.config import ServerConfig, get_config
from tim_mcp_server.logging_config import setup_logging, logger
from tim_mcp_server.log_system.correlation import (
    generate_correlation_id,
    set_initialization_correlation_id,
    clear_initialization_correlation_id
)
from tim_mcp_server.log_system.unified_logger import UnifiedLogger

from tim_mcp_server.tools.example_tools import example_tools, parallel_example_tools
...
def create_mcp_server(config: Optional[ServerConfig] = None) -> FastMCP:
    ...
    from tim_mcp_server.log_system.destinations import DestinationConfig
    ...
    import logging
    unified_logger = logging.getLogger('tim_mcp_server')
...
def register_tools(mcp_server: FastMCP, config: ServerConfig) -> None:
    ...
    # Import decorators
    from tim_mcp_server.decorators.exception_handler import exception_handler
    from tim_mcp_server.decorators.tool_logger import tool_logger
    from tim_mcp_server.decorators.type_converter import type_converter
    from tim_mcp_server.decorators.parallelize import parallelize
