...
from tim_mcp_server.decorators.sqlite_logger import (
    SQLiteLoggerSink, 
...
class TestSQLiteLogger:
    ...
    def test_database_initialization(self, temp_db_path):
        ...
        with patch('tim_mcp_server.decorators.sqlite_logger.SQLiteLoggerSink._get_database_path') as mock_path:
    ...
    def test_log_tool_execution_function(self, temp_db_path):
        ...
        with patch.object(sink, '_db_path', temp_db_path):
            ...
            with patch('tim_mcp_server.decorators.sqlite_logger.logger') as mock_logger:
