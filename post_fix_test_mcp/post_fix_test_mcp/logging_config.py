"""Logging configuration for Post-fix Test MCP MCP server"""
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the Post-fix Test MCP MCP server"""
    ...
    project_logger = logging.getLogger("post_fix_test_mcp")
    ...
    log_file = log_path / "post_fix_test_mcp.log"
...
logger = logging.getLogger("post_fix_test_mcp")
