"""Configuration management for Post-fix Test MCP
...
class ServerConfig:
    ...
    def __post_init__(self):
        ...
        if self.config_dir is None:
            self.config_dir = Path(platformdirs.user_config_dir("post_fix_test_mcp"))
        if self.data_dir is None:
            self.data_dir = Path(platformdirs.user_data_dir("post_fix_test_mcp"))
        if self.log_dir is None:
            self.log_dir = Path(platformdirs.user_log_dir("post_fix_test_mcp"))
        ...
        self.log_file_path = self.log_dir / "post_fix_test_mcp.log"
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ServerConfig":
        ...
        if "server" in data:
            ...
            return cls(
                name=server_config.get("name", "Post-fix Test MCP"),
            ...
            return cls(
                name=data.get("name", "Post-fix Test MCP"),
...
def get_platform_info() -> Dict[str, str]:
    ...
    return {
        "config_dir": str(platformdirs.user_config_dir("post_fix_test_mcp")),
        "data_dir": str(platformdirs.user_data_dir("post_fix_test_mcp")),
        "log_dir": str(platformdirs.user_log_dir("post_fix_test_mcp")),
        "cache_dir": str(platformdirs.user_cache_dir("post_fix_test_mcp")),
    }
