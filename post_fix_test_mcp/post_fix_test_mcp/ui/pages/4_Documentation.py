"""Documentation viewer page for Post-fix Test MCP Admin UI
...
def render_documentation_content():
    ...
    st.markdown("""
    This MCP server was generated from the Post-fix Test MCP Cookie Cutter template.
    
    **Getting Started:**
    1. Test your server with MCP Inspector: `mcp dev post_fix_test_mcp/server/app.py`
    2. Run the example client: `post_fix_test_mcp-client "Hello World"`
...
def main():
    ...
    # Page header
    st.title("📖 Post-fix Test MCP Documentation")
