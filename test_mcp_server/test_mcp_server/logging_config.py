"""Logging configuration for Test MCP Server Auto MCP server"""
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the Test MCP Server Auto MCP server"""
    ...
    project_logger = logging.getLogger("test_mcp_server")
    ...
    log_file = log_path / "test_mcp_server.log"
